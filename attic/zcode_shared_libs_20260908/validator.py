...
supported_functions = {
    ...
    'bucket': {'min_args': 1, 'max_args': 3, 'arg_types': ['expression', 'string', 'string'], 'param_names': ['x', 'range', 'buckets']},  # 平台: bucket(rank(x), range='0,1,0.1') 或 bucket(rank(x), buckets='2,5,6,7,10')
