# -*- coding: utf-8 -*-
"""提交 AQ 批: macro38 追批 - 换手控制主线 (AP 批 短期变化 1.09/2y1.35 但 tv 56.5%), decay4/SUBIND。"""
...
async def main():
    ...
    await submit('AQ', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_macro38_batch_aq.txt', 4, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
