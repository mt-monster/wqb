# -*- coding: utf-8 -*-
"""提交 order_book_imbalance 探针批 AF（三重复合 + 权重变体 + 差异信号，decay8/SUBIND）。"""
...
async def main():
    ...
    await submit('AF', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_batch_af.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
