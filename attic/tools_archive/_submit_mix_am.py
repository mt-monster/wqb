# -*- coding: utf-8 -*-
"""提交 AM 批: si3×obim 乘法族精调 (kqPpZqxz 1.09/2y1.06 骨架), decay4/SUBIND。"""
...
async def main():
    ...
    await submit('AM', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_mix_batch_am.txt', 4, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
