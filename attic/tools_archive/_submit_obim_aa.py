# -*- coding: utf-8 -*-
"""提交 order_book_imbalance 探针批 AA（decay2/SUBIND），直接 POST /simulations 数组。"""
...
async def main():
    ...
    await submit('AA', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_batch_aa.txt', 2, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
