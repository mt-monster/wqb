...
import ace_lib
cfg = json.load(open(os.path.join(os.path.dirname(os.environ.get("WQ_ACE_LIB", os.path.join(os.path.expanduser("~"), ".workbuddy", "skills", "brain-sim-alphas-in-batch-and-track", "scripts"))), 'configs', 'config.json')))
