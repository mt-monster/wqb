...
import os
"""
wave17 ASI chart_cnn_alpha CNN enhance runner.
...
INPUT = "tracking/ASI/candidates/asi_wave21_cnn_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ctx = CampaignContext("tracking/ASI")
    ...
    out_dir = Path("tracking/ASI/results")
    out_dir.mkdir(parents=True, exist_ok=True)
    out_json = out_dir / "wave21_cnn_results.json"
    out_csv = out_dir / "wave21_cnn_results.csv"
