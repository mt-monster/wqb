...
import os
"""
wave15 ASI msm neut-scan prod-corr reduction runner.
Input: asi_wave15_msm_neut_items.json [{code, note}],
...
INPUT = "tracking/ASI/candidates/asi_wave15_msm_neut_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave15_msm_neut_results.json"
    out_csv = out_dir / "wave15_msm_neut_results.csv"
