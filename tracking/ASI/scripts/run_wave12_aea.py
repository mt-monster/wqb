...
import os
"""
wave12 ASI ai_equity_alpha cross-family probe runner.
Input: asi_wave12_aea_items.json [{code, note}],
...
INPUT = "tracking/ASI/candidates/asi_wave12_aea_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave12_aea_results.json"
    out_csv = out_dir / "wave12_aea_results.csv"
