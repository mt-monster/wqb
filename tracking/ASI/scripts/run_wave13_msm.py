...
import os
"""
wave13 ASI multi_source_model quantile-diff probe runner.
Input: asi_wave13_msm_items.json [{code, note}],
...
INPUT = "tracking/ASI/candidates/asi_wave13_msm_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave13_msm_results.json"
    out_csv = out_dir / "wave13_msm_results.csv"
