...
import os
"""
wave16 ASI chart_cnn_alpha imgfeat probe runner.
Input: asi_wave16_cnn_items.json [{code, note}],
...
INPUT = "tracking/ASI/candidates/asi_wave16_cnn_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave16_cnn_results.json"
    out_csv = out_dir / "wave16_cnn_results.csv"
