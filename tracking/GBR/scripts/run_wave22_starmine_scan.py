...
import os
"""
wave22 predictive_starmine parameter-scan runner (per-item decay overrides).
Input: gbr_wave22_starmine_scan_items.json [{code, decay}], 3 batches x 8 items,
...
INPUT = "tracking/GBR/candidates/gbr_wave22_starmine_scan_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave22_starmine_scan_results.json"
    out_csv = out_dir / "wave22_starmine_scan_results.csv"
