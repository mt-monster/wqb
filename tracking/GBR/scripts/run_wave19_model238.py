...
# -*- coding: utf-8 -*-
"""
wave19 model238 五槽回测 runner。
输入 gbr_wave19_exprs.json（meta+expressions），单数据集 3 批 x 8 表达式，
...
DATASET = "model238"
INPUT = "tracking/GBR/candidates/gbr_wave19_exprs.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave19_model238_results.json"
    out_csv = out_dir / "wave19_model238_results.csv"
