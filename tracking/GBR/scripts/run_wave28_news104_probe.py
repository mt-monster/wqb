...
# -*- coding: utf-8 -*-
"""
wave28 news104 probe runner.
Input: gbr_wave28_news104_items.json [{code}],
...
DATASET = "news104"
INPUT = "tracking/GBR/candidates/gbr_wave28_news104_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave28_news104_probe_results.json"
    out_csv = out_dir / "wave28_news104_probe_results.csv"
