...
import os
"""
wave25 predictive_starmine refine runner (per-item decay/truncation overrides).
Input: gbr_wave25_starmine_refine_items.json [{code, decay, truncation?}],
...
INPUT = "tracking/GBR/candidates/gbr_wave25_starmine_refine_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave25_starmine_refine_results.json"
    out_csv = out_dir / "wave25_starmine_refine_results.csv"
