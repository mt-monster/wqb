...
5 multisim 骞跺彂濉Ы锛岃疆璇㈣嚦 TERMINAL锛屾媺鍙?IS 鎸囨爣锛屽啓 JSON/CSV銆?
"""
import csv
import json
import sys
...
DATASET = "sentiment27"
INPUT = "tracking/GBR/candidates/gbr_wave20_exprs.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave20_sentiment27_results.json"
    out_csv = out_dir / "wave20_sentiment27_results.csv"
