...
# -*- coding: utf-8 -*-
"""
wave27 model264 probe runner.
Input: gbr_wave27_model264_items.json [{code}],
...
DATASET = "model264"
INPUT = "tracking/GBR/candidates/gbr_wave27_model264_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave27_model264_probe_results.json"
    out_csv = out_dir / "wave27_model264_probe_results.csv"
