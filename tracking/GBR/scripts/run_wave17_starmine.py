...
import os
"""
wave17 predictive_starmine 五槽回测 runner。
输入 gbr_wave17_exprs.json（meta+expressions），单数据集 3 批 x 8 表达式，
5 multisim 并发填槽，轮询至 TERMINAL，拉取 IS 指标，写 JSON/CSV。
"""
import csv
import json
import sys
...
INPUT = "tracking/GBR/candidates/gbr_wave17_exprs.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave17_starmine_results.json"
    out_csv = out_dir / "wave17_starmine_results.csv"
