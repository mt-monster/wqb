...
import os
"""
wave26 pattern_scores probe runner.
Input: gbr_wave26_pattern_items.json [{code}],
...
INPUT = "tracking/GBR/candidates/gbr_wave26_pattern_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave26_pattern_probe_results.json"
    out_csv = out_dir / "wave26_pattern_probe_results.csv"
