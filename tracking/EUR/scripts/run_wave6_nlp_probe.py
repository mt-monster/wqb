...
# -*- coding: utf-8 -*-
"""
wave6 EUR news_sentiment_nlp probe runner.
Input: eur_wave6_nlp_probe_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave6_nlp_probe_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave6_nlp_probe_results.json"
    out_csv = out_dir / "wave6_nlp_probe_results.csv"
