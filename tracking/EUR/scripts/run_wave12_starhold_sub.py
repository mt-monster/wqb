...
import os
"""
wave12 EUR shortinterest6 sub-universe fix runner.
Input: eur_wave12_starhold_sub_items.json [{code, note}],
...
DATASET = "shortinterest6"
INPUT = "tracking/EUR/candidates/eur_wave12_starhold_sub_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave12_starhold_sub_results.json"
    out_csv = out_dir / "wave12_starhold_sub_results.csv"
