...
# -*- coding: utf-8 -*-
"""
wave5 EUR price_signal_dl + pattern_scores probe runner.
Input: eur_wave5_pspat_items.json [{code, dataset}],
...
INPUT = "tracking/EUR/candidates/eur_wave5_pspat_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave5_pspat_probe_results.json"
    out_csv = out_dir / "wave5_pspat_probe_results.csv"
