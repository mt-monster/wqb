...
# -*- coding: utf-8 -*-
"""
wave14 EUR multi_horizon_alpha FCF15 RN-fix runner.
Input: eur_wave14_fcf15_fix_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave14_fcf15_fix_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave14_fcf15_fix_results.json"
    out_csv = out_dir / "wave14_fcf15_fix_results.csv"
