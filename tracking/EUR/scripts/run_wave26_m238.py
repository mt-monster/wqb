...
# -*- coding: utf-8 -*-
"""
wave20 EUR model238 seasonal probe runner.
Input: eur_wave26_m238_items.json [{code, note}],
...
DATASET = "model238"
INPUT = "tracking/EUR/candidates/eur_wave26_m238_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave26_m238_results.json"
    out_csv = out_dir / "wave26_m238_results.csv"
