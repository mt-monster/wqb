...
# -*- coding: utf-8 -*-
"""
wave10 EUR shortinterest6 probe runner.
Input: eur_wave10_starhold_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave10_starhold_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave10_starhold_probe_results.json"
    out_csv = out_dir / "wave10_starhold_probe_results.csv"
