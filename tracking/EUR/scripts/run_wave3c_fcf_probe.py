...
# -*- coding: utf-8 -*-
"""
wave3c EUR fcf enhance probe runner.
Input: eur_wave3c_fcf_items.json [{code}],
...
INPUT = "tracking/EUR/candidates/eur_wave3c_fcf_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave3c_fcf_probe_results.json"
    out_csv = out_dir / "wave3c_fcf_probe_results.csv"
