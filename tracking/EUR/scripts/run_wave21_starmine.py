...
# -*- coding: utf-8 -*-
"""
wave20 EUR predictive_starmine seasonal probe runner.
Input: eur_wave21_starmine_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave21_starmine_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave21_starmine_results.json"
    out_csv = out_dir / "wave21_starmine_results.csv"
