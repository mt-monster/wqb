...
# -*- coding: utf-8 -*-
"""
wave3b EUR mirror fundamental probe runner.
Input: eur_wave3b_mirror_items.json [{code}],
...
INPUT = "tracking/EUR/candidates/eur_wave3b_mirror_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave3b_mirror_probe_results.json"
    out_csv = out_dir / "wave3b_mirror_probe_results.csv"
