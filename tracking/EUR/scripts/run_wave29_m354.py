...
Input: eur_wave29_m354_items.json [{code, note}],
...
DATASET = "model354"
INPUT = "tracking/EUR/candidates/eur_wave29_m354_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave29_m354_results.json"
    out_csv = out_dir / "wave29_m354_results.csv"
