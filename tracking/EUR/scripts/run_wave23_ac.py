...
# -*- coding: utf-8 -*-
"""
wave20 EUR analyst_consensus seasonal probe runner.
Input: eur_wave23_ac_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave23_ac_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave23_ac_results.json"
    out_csv = out_dir / "wave23_ac_results.csv"
