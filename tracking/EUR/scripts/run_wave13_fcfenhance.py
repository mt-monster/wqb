...
# -*- coding: utf-8 -*-
"""
wave13 EUR multi_horizon_alpha FCF enhance runner.
Input: eur_wave13_fcfenhance_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave13_fcfenhance_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave13_fcfenhance_results.json"
    out_csv = out_dir / "wave13_fcfenhance_results.csv"
