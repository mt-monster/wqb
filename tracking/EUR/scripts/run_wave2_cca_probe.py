...
# -*- coding: utf-8 -*-
"""
wave2 EUR chart_cnn_alpha probe runner.
Input: eur_wave2_cca_items.json [{code}],
...
INPUT = "tracking/EUR/candidates/eur_wave2_cca_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave2_cca_probe_results.json"
    out_csv = out_dir / "wave2_cca_probe_results.csv"
