...
Input: eur_wave6b_fcfmix_items.json [{code, dataset, tag}],
...
INPUT = "tracking/EUR/candidates/eur_wave6b_fcfmix_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave6b_fcfmix_probe_results.json"
    out_csv = out_dir / "wave6b_fcfmix_probe_results.csv"
