...
import os
"""
wave18 EUR ai_factor_transfer tech-indicator probe runner.
Input: eur_wave18_aft_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave18_aft_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave18_aft_results.json"
    out_csv = out_dir / "wave18_aft_results.csv"
