...
Input: eur_wave30_news54_items.json [{code, note}],
...
DATASET = "news54"
INPUT = "tracking/EUR/candidates/eur_wave30_news54_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave30_news54_results.json"
    out_csv = out_dir / "wave30_news54_results.csv"
