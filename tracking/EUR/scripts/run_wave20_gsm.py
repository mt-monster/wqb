...
import os
"""
wave20 EUR global_seasonal_model seasonal probe runner.
Input: eur_wave20_gsm_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave20_gsm_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave20_gsm_results.json"
    out_csv = out_dir / "wave20_gsm_results.csv"
