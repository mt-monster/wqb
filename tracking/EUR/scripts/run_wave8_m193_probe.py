...
import os
"""
wave8 EUR model193 probe runner.
Input: eur_wave8_m193_items.json [{code, note}],
...
DATASET = "model193"
INPUT = "tracking/EUR/candidates/eur_wave8_m193_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave8_m193_probe_results.json"
    out_csv = out_dir / "wave8_m193_probe_results.csv"
