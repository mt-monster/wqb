...
# -*- coding: utf-8 -*-
"""
wave15 EUR multi_horizon_alpha FCF deep-gradient runner.
Input: eur_wave15_fcf_deep_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave15_fcf_deep_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave15_fcf_deep_results.json"
    out_csv = out_dir / "wave15_fcf_deep_results.csv"
