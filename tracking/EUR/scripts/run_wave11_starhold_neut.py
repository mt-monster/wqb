...
import os
"""
wave11 EUR shortinterest6 neut-scan runner.
Input: eur_wave11_starhold_neut_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave11_starhold_neut_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave11_starhold_neut_results.json"
    out_csv = out_dir / "wave11_starhold_neut_results.csv"
