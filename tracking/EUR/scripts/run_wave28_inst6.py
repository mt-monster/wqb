...
# -*- coding: utf-8 -*-
"""
wave20 EUR institutions6 seasonal probe runner.
Input: eur_wave28_inst6_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave28_inst6_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave28_inst6_results.json"
    out_csv = out_dir / "wave28_inst6_results.csv"
