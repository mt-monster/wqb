...
# -*- coding: utf-8 -*-
"""
wave9 EUR ml_factor_proj probe runner.
Input: eur_wave9_mlfp_items.json [{code, note}],
...
DATASET = "ml_factor_proj"
INPUT = "tracking/EUR/candidates/eur_wave9_mlfp_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave9_mlfp_probe_results.json"
    out_csv = out_dir / "wave9_mlfp_probe_results.csv"
