...
import os
"""
wave7 EUR ai_news_scores probe runner.
Input: eur_wave7_ains_items.json [{code, note}],
...
INPUT = "tracking/EUR/candidates/eur_wave7_ains_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave7_ains_probe_results.json"
    out_csv = out_dir / "wave7_ains_probe_results.csv"
