...
import os
"""
wave16 EUR other571 Wikipedia pageviews probe runner.
Input: eur_wave16_oth571_items.json [{code, note}],
...
DATASET = "other571"
INPUT = "tracking/EUR/candidates/eur_wave16_oth571_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave16_oth571_results.json"
    out_csv = out_dir / "wave16_oth571_results.csv"
