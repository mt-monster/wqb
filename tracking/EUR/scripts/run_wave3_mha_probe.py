...
import os
"""
wave3 EUR multi_horizon_alpha probe runner.
Input: eur_wave3_mha_items.json [{code}],
...
INPUT = "tracking/EUR/candidates/eur_wave3_mha_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave3_mha_probe_results.json"
    out_csv = out_dir / "wave3_mha_probe_results.csv"
