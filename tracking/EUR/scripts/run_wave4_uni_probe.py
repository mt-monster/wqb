...
Input: eur_wave4_uni_items.json [{code, universe}],
...
INPUT = "tracking/EUR/candidates/eur_wave4_uni_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave4_uni_probe_results.json"
    out_csv = out_dir / "wave4_uni_probe_results.csv"
