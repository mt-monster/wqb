...
# -*- coding: utf-8 -*-
"""
wave1 EUR news_sentiment_dl probe runner.
Input: eur_wave1_nsd_items.json [{code}],
...
INPUT = "tracking/EUR/candidates/eur_wave1_nsd_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave1_nsd_probe_results.json"
    out_csv = out_dir / "wave1_nsd_probe_results.csv"
