...
# -*- coding: utf-8 -*-
"""
wave20 EUR fund_holdings_panel seasonal probe runner.
Input: eur_wave25_fhp_items.json [{code, note}],
...
DATASET = "fund_holdings_panel"
INPUT = "tracking/EUR/candidates/eur_wave25_fhp_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave25_fhp_results.json"
    out_csv = out_dir / "wave25_fhp_results.csv"
