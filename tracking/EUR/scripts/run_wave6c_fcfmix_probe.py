...
import os
"""
wave6c EUR FCF x hetero deep-dilution mix probe runner.
Input: eur_wave6c_fcfmix_items.json [{code, dataset, tag}],
...
INPUT = "tracking/EUR/candidates/eur_wave6c_fcfmix_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave6c_fcfmix_probe_results.json"
    out_csv = out_dir / "wave6c_fcfmix_probe_results.csv"
