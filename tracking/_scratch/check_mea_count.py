...
with open(r'C:\Users\MENGTAO\.qoder-cn\cache\projects\wqb-a40170ec\agent-tools\task-d8b\097a03f0.txt') as f:
    data = json.load(f)
...
if qualified:
    ...
    for alpha in qualified:
        m = alpha['metrics']
        print(f"ID: {alpha['id']}, Sharpe: {m['sharpe']:.2f}, Fitness: {m['fitness']:.2f}")
else:
    print('\n无达标 alpha，继续挖掘...')