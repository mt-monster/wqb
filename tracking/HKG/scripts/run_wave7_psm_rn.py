...
import os
"""
wave7 HKG predictive_starmine rn-fix probe runner.
Input: hkg_wave7_psm_rn_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave7_psm_rn_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave7_psm_rn_results.json"
    out_csv = out_dir / "wave7_psm_rn_results.csv"
