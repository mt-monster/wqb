...
import os
"""
wave1 HKG news_sentiment_nlp probe runner.
Input: hkg_wave1_nsnlp_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave1_nsnlp_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave1_nsnlp_results.json"
    out_csv = out_dir / "wave1_nsnlp_results.csv"
