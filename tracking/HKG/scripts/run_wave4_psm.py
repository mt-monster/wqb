...
import os
"""
wave4 HKG predictive_starmine probe runner.
Input: hkg_wave4_psm_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave4_psm_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave4_psm_results.json"
    out_csv = out_dir / "wave4_psm_results.csv"
