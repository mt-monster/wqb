...
import os
"""
wave5 HKG predictive_starmine IV-enhance probe runner.
Input: hkg_wave5_psm_iv_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave5_psm_iv_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave5_psm_iv_results.json"
    out_csv = out_dir / "wave5_psm_iv_results.csv"
