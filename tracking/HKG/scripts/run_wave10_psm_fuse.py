...
import os
"""
wave10 HKG predictive_starmine fuse IV+ARM+PE probe runner.
Input: hkg_wave10_psm_fuse_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave10_psm_fuse_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave10_psm_fuse_results.json"
    out_csv = out_dir / "wave10_psm_fuse_results.csv"
