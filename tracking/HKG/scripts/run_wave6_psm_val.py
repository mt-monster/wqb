...
import os
"""
wave6 HKG predictive_starmine value-enhance probe runner.
Input: hkg_wave6_psm_val_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave6_psm_val_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave6_psm_val_results.json"
    out_csv = out_dir / "wave6_psm_val_results.csv"
