...
import os
"""
wave9 HKG predictive_starmine PE-direction-fix probe runner.
Input: hkg_wave9_psm_pefix_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave9_psm_pefix_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ctx = CampaignContext("tracking/HKG")
    ...
    out_dir = Path("tracking/HKG/results")
    out_dir.mkdir(parents=True, exist_ok=True)
    out_json = out_dir / "wave9_psm_pefix_results.json"
    out_csv = out_dir / "wave9_psm_pefix_results.csv"
