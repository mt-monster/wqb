...
import os
"""
wave11 HKG price_signal_dl + cross-dataset fuse probe runner.
Input: hkg_wave11_psd_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave11_psd_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave11_psd_results.json"
    out_csv = out_dir / "wave11_psd_results.csv"
