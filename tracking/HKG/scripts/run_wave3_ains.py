...
import os
"""
wave3 HKG ai_news_scores probe runner.
Input: hkg_wave3_ains_items.json [{code, note}],
...
DATASET = "ai_news_scores"
INPUT = "tracking/HKG/candidates/hkg_wave3_ains_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave3_ains_results.json"
    out_csv = out_dir / "wave3_ains_results.csv"
