...
import os
"""
wave8 HKG predictive_starmine 4way-composite probe runner.
Input: hkg_wave8_psm_4way_items.json [{code, note}],
...
INPUT = "tracking/HKG/candidates/hkg_wave8_psm_4way_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave8_psm_4way_results.json"
    out_csv = out_dir / "wave8_psm_4way_results.csv"
