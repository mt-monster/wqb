...
# -*- coding: utf-8 -*-
"""
wave2 HKG news_sentiment_nlp ts-enhance probe runner.
Input: hkg_wave2_nsnlp_ts_items.json [{code, note}],
5 multisim concurrent fill (batch_size=8), poll to TERMINAL, fetch IS metrics,
write JSON/CSV. 澶嶇敤浜旀Ы濉Ы妯″紡锛坵qb-concurrency 搂8锛夈€?
"""
import csv
import json
import sys
...
INPUT = "tracking/HKG/candidates/hkg_wave2_nsnlp_ts_items.json"
SLOTS = 5
BATCH_SIZE = 8
POLL_INTERVAL = 15
STALL_MINUTES = 8
...
def main():
    ...
    out_json = out_dir / "wave2_nsnlp_ts_results.json"
    out_csv = out_dir / "wave2_nsnlp_ts_results.csv"
