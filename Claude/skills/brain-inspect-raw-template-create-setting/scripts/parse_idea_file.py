...
# Dataset IDs may contain underscores (ai_factor_transfer, ml_factor_proj).
# Match from the right: ..._{REGION}_{0|1}_idea_{digits}.json
_FILENAME_RE = re.compile(
    r"^(?P<dataset>.+)_(?P<region>[A-Za-z]+)_(?P<delay>[01])_idea_\d+\.json$"
)
