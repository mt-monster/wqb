# -*- coding: utf-8 -*-
"""提交 AO 批: si3×obim 乘法族 decay2 矩阵 (margin 解锁测试), decay2/SUBIND。"""
...
async def main():
    ...
    await submit('AO', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_mix_batch_ao.txt', 2, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
