# -*- coding: utf-8 -*-
"""提交 order_book_imbalance 探针批 AE（双亮点复合 + 未测字段族，decay8/SUBIND）。"""
...
async def main():
    ...
    await submit('AE', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_batch_ae.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
