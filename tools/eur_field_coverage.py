...
# 各区域合法 universe / delay / neutralization
# 来源：OPTIONS /simulations 实测拉取（2026-08-09，fetch_all_universes.py）
# 原始数据：tracking/mining/platform_universes_all_regions.json
VALID_UNIVERSES = {
...
VALID_NEUTRALIZATIONS = {
    ...
    "HKG": ["NONE", "REVERSION_AND_MOMENTUM", "STATISTICAL", "CROWDING", "FAST", "SLOW", "MARKET", "SECTOR", "INDUSTRY", "SUBINDUSTRY", "SLOW_AND_FAST"],
    "KOR": ["NONE", "REVERSION_AND_MOMENTUM", "STATISTICAL", "CROWDING", "FAST", "SLOW", "MARKET", "SECTOR", "INDUSTRY", "SUBINDUSTRY", "SLOW_AND_FAST"],
    "IND": ["NONE", "REVERSION_AND_MOMENTUM", "STATISTICAL", "CROWDING", "FAST", "SLOW", "MARKET", "SECTOR", "INDUSTRY", "SUBINDUSTRY", "SLOW_AND_FAST"],
    "GBR": ["NONE", "REVERSION_AND_MOMENTUM", "STATISTICAL", "CROWDING", "FAST", "SLOW", "MARKET", "SECTOR", "INDUSTRY", "SUBINDUSTRY", "SLOW_AND_FAST"],
    "DEU": ["NONE", "REVERSION_AND_MOMENTUM", "STATISTICAL", "CROWDING", "FAST", "SLOW", "MARKET", "SECTOR", "INDUSTRY", "SUBINDUSTRY", "SLOW_AND_FAST"],
...
def main():
    ...
    ap.add_argument("--out-dir", default="tracking/mining")
    args = ap.parse_args()
