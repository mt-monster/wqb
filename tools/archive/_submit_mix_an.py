# -*- coding: utf-8 -*-
"""提交 AN 批: si3×obim 乘法冠军终调 (RRmx1VKa 1.10/2y1.07 骨架), decay4/SUBIND。"""
...
async def main():
    ...
    await submit('AN', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_mix_batch_an.txt', 4, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
