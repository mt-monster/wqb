# -*- coding: utf-8 -*-
"""提交 AG 批: order_book_imbalance × analyst44 双数据集混合 (知情交易确认, decay8/SUBIND)。"""
...
async def main():
    ...
    await submit('AG', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_anl44_batch_ag.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
