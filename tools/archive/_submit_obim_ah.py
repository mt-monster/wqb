# -*- coding: utf-8 -*-
"""提交 AH 批: obim×analyst44 混合精调 (AG 冠军变体 + executed 三成员结构, decay8/SUBIND)。"""
...
async def main():
    ...
    await submit('AH', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_anl44_batch_ah.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
