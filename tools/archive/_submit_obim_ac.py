# -*- coding: utf-8 -*-
"""提交 order_book_imbalance 探针批 AC（market impact 精调，decay8/SUBIND），直接 POST /simulations 数组。"""
...
async def main():
    ...
    await submit('AC', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_batch_ac.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
