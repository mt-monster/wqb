# -*- coding: utf-8 -*-
"""提交 inst6 终验批（decay2 提 tv + signed_power/market_value/num 口径），直接 POST /simulations 数组。"""
...
async def main():
    ...
    await submit(r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_inst6_batch_tune.txt', 2)
    time.sleep(5)
    print('ALL SUBMITTED')
