# -*- coding: utf-8 -*-
"""提交 AJ 批: 混合冠军精调3 (decay16 慢变 + impact-spread 组合, SUBIND)。"""
...
async def main():
    ...
    await submit('AJ', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_anl44_batch_aj.txt', 16, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
