# -*- coding: utf-8 -*-
"""提交 AL 批: si3×obim 混合追批 (RRmxpwxa 0.94 骨架精调), decay4/SUBIND。"""
...
async def main():
    ...
    await submit('AL', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_mix_batch_al.txt', 4, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
