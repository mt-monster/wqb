# -*- coding: utf-8 -*-
"""提交 inst6 STAT 批（neutralization=STATISTICAL 终验），直接 POST /simulations 数组。"""
...
async def main():
    ...
    await submit(r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_inst6_batch_stat.txt', 8)
    time.sleep(5)
    print('ALL SUBMITTED')
