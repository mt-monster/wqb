# -*- coding: utf-8 -*-
"""提交 AP 批: macro38 Technical Ratings 技术面探针 (波12 首发), decay4/SUBIND。"""
...
async def main():
    ...
    await submit('AP', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_macro38_batch_ap.txt', 4, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
