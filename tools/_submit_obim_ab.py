# -*- coding: utf-8 -*-
"""提交 order_book_imbalance 探针批 AB（decay8/SUBIND 慢变字段族），直接 POST /simulations 数组。"""
...
async def main():
    ...
    await submit('AB', r'd:\coding\traeCN_project\wqb\tracking\USA\runs\usa_obim_batch_ab.txt', 8, 'SUBINDUSTRY')
    time.sleep(5)
    print('ALL SUBMITTED')
